...
test:
	gcc -static -g usr/test/test.c -o bin/test.elf -L$(LIB_PREFIX) -lc -lsyscall -nostdlib -nostdinc $(INCLUDES) -nostartfiles -nodefaultlibs -w -e entry -T usr/test/test.lds -mgeneral-regs-only -mno-sse
